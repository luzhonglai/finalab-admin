package com.bytetcp.finalab.generator.util;
...
//    private static final String PROJECT_PATH = getProjectPath();
    ...
    public static String getFileName(String template, TableInfo table, String moduleName) {
        ...
        // 大写类名
        String className = table.getClassName();
        String javaPath = getProjectPath(table.getClassname());
    ...
    public static String getProjectPath(String classname) {
        String packageName = Global.getPackageName() + "." + classname;
