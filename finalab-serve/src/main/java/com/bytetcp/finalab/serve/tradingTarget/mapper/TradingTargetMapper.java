package com.bytetcp.finalab.serve.tradingTarget.mapper;
 ...
 * @date 2019-05-01
 */
public interface TradingTargetMapper
{
	/**
     * 查询标的信息
     *
     ...
     * @return 结果
     */
	public int deleteTradingTargetById(Long id);
	...
	public int deleteTradingTargetByActive(TradingTarget tradingTarget);


	public int insertTradingTargetList(@Param("tradingTargets") List<TradingTarget> tradingTargets);
