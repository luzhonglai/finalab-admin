package com.bytetcp.finalab.serve.clearActionDetail.service;
...
/**
 * 记录用户的平仓动作，一次平仓一条记录。平仓之前会记录用户该股票的成本价，这样才能计算出盈亏 服务层
 *
 * @author finalab
 * @date 2019-08-02
 */
public interface IClearActionDetailService {
    /**
    ...
    /**
     * 删除记录用户的平仓动作，一次平仓一条记录。平仓之前会记录用户该股票的成本价，这样才能计算出盈亏信息
     *
     * @param ids 需要删除的数据ID
     * @return 结果
     */
