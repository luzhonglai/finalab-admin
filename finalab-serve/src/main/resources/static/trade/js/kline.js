...
var crossColor = "#FFFFFF";
var upColor="#FF0000";//涨颜色
var downColor="#1aaa00";//跌颜色
...
function getNextTs(maxTime,resultArr){
...
var time_arr = function(type) {
	if(type.indexOf('cn')!=-1){//生成美股时间段{
		var timeArr = new Array();
		// return getNextTs(240,timeArr);
		return getNextTs(courseCasesParam.TicksPerPeriod,timeArr);
	}
