package com.bytetcp.finalab.common.utils.file;

import java.io.File;
import java.io.IOException;

import com.bytetcp.finalab.common.exception.file.FileNameLengthLimitExceededException;
import org.springframework.web.multipart.MultipartFile;
import com.bytetcp.finalab.common.config.Global;
import com.bytetcp.finalab.common.exception.file.FileSizeLimitExceededException;
...
public class FileUploadUtils
{
    ...
    public static final String uploadExcel(String baseDir, MultipartFile file) throws IOException
    {
        try
        {
            return upload(baseDir, file, FileUploadUtils.EXCEL_EXTENSION);
        }
        catch (Exception e)
        {
            throw new IOException(e.getMessage(), e);
