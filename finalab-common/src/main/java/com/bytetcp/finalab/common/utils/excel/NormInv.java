 ...
 */
public class NormInv implements Function {
    public ValueEval evaluate(ValueEval[] args, int i, int i1) {
        try {
            final ValueEval p = OperandResolver.getSingleValue(args[0], i, i1);
            final ValueEval mu = OperandResolver.getSingleValue(args[1], i, i1);
            final ValueEval sigma = OperandResolver.getSingleValue(args[2], i, i1);
