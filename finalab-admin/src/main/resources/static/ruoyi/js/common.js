...
$(function() {
	...
	var $table = $.common.isEmpty($.table._option._tableObj) ? $('#bootstrap-table') : $.table._option._tableObj;
...
function closeCurrentTab() {
    var topWindow = $(window.parent.document);
    $('.menuTabs .page-tabs-content', topWindow).find('.active i').trigger("click");
}
